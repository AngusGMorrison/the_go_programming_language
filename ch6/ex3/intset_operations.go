// (*IntSet).UnionWith computes the union of two sets using |, the word-parallel bitwise OR
// operator. Implement methods for IntersectWith, DifferenceWith, and SymetricDifference for the
// corresponding set operations. (The symmetric difference of two sets contains the elements
